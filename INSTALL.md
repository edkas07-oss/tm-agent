...
This document provides instructions for compiling, installing, and deploying the **`tm-agent`** (*Unified Cross-Platform Event Collector Daemon*) across Linux and Windows Server environments.
